...
export interface Pile {
    ...
    value: Card;
    bookedBy?: number; // player index who booked this pile, or undefined
}
...
export type BookingAction = { pileId: number, action: 'book' | 'release' } | null;
export type StrategyWithBooking = Strategy & {
    updateBooking?: (gameState: GameState, playerIndex: number) => BookingAction;
}; 